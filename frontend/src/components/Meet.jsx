...
const Meet = () => {
  ...
  return (
    <section id="about" className="bg-white py-32">
      <div className="container mx-auto px-6 max-w-[1080px] space-y-12">
        ...
        <div
          className={`grid grid-cols-1 md:grid-cols-2 gap-6 items-center fade-in-row transition-all duration-[2000ms] ease-in-out ${
            rowInView[0]
